...
**Low-resolution dataset (synthetic):**
- Generated by downsampling the **denoised** high-resolution data
- Multiple downsampling factors will be explored to study the relationship between resolution loss and super-resolution recovery
